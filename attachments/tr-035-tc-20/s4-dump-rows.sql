...
SELECT
    CAST(Implementation_External_ID__c AS NVARCHAR(36)) AS Implementation_External_ID__c,
    CAST(Contact__c AS NVARCHAR(36))                     AS Contact__c,
    CAST(Household_Organization__c AS NVARCHAR(36))      AS Household_Organization__c,
    Attribute_Name__c,
    Attribute_Group__c,
    Data_Type__c,
    Value_Text__c,
    CAST(Value_Boolean__c AS NVARCHAR(5))                AS Value_Boolean__c,
    CONVERT(NVARCHAR(10), Value_Date__c, 23)             AS Value_Date__c,
    CAST(Value_Number__c AS NVARCHAR(40))                AS Value_Number__c,
    Comment__c,
    CONVERT(NVARCHAR(10), Start_Date__c, 23)             AS Start_Date__c,
    CONVERT(NVARCHAR(10), End_Date__c, 23)               AS End_Date__c,
    CAST(Source_Category_ID__c AS NVARCHAR(36))          AS Source_Category_ID__c,
