...
DECLARE @constituent_uuid UNIQUEIDENTIFIER = 'D7C13236-CE83-4BEA-A798-78E2575441D2';
...
SELECT
    CAST(Implementation_External_ID__c AS NVARCHAR(36)) AS attr_id,
    Attribute_Name__c,
    Data_Type__c,
    Value_Text__c,
...
FROM #out
WHERE Contact__c = @constituent_uuid
